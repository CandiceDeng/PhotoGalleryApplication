...
function scaleGallery() {
  ...
  while (i < numPhotos) {
    ...
    while (i < numPhotos && ratioSum < ratioSumMax) {
      photo = $(imgs[i]); // reset width to original

      photo.width("");
      ratio = photo.width() / photo.height();
      rowPadding += getHorizontalPadding(photo); // if this is going to be first in the row, clear: left

      if (ratioSum == 0) photo.css("clear", "left");else photo.css("clear", "none");
      ratioSum += ratio;
      row.push(photo);
      i++; // if only 1 image left, squeeze it in
...
__webpack_require__(/*! /Users/CandiceDeng 1/PhotoGalleryApplication/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/CandiceDeng 1/PhotoGalleryApplication/resources/sass/app.scss */"./resources/sass/app.scss");
